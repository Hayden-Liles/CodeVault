...
/**
 * @description Saves state data to local storage.
...
/**
 * @description Loads state data from local storage.
 * @param {string} key - The key to load the data from.
 * @param {any} instanceType - The instance type to create from the data.
 * @returns {any} The loaded state data.
 */
